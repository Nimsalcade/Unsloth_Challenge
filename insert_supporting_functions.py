...
# Create supporting functions cell
...
# Insert supporting functions at position 36
...
print("Successfully inserted supporting functions at position 36")
print(f"Total cells now: {len(nb['cells'])}")

# Verify insertion
cell_36 = nb['cells'][36]
source_36 = ''.join(cell_36['source'])
has_cross_entropy = 'chunked_cross_entropy_forward' in source_36
has_wrapper = 'memory_efficient_forward' in source_36
print(f"Supporting functions inserted correctly: {has_cross_entropy and has_wrapper}")